...
public class EventInterpreter {
    ...
    final PhonyKeyboard mPhonyKeyboard;
     ...
     *
     * @param phonyKeyboard a reference to the ime.
     */
    public EventInterpreter(final PhonyKeyboard phonyKeyboard) {
        this(null, phonyKeyboard);
    }
     ...
     * @param phonyKeyboard a reference to the ime.
     */
    public EventInterpreter(final EventDecoderSpec specification, final PhonyKeyboard phonyKeyboard) {
    ...
    private boolean onEvent(final Event event) {
        ...
        while (null != currentlyProcessingEvent) {
            if (currentlyProcessingEvent.isCommittable()) {
                mPhonyKeyboard.onCodeInput(currentlyProcessingEvent.mCodePoint,

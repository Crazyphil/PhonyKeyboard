...
import static at.jku.fim.phonykeyboard.latin.Constants.ImeOption.FORCE_ASCII;
import static at.jku.fim.phonykeyboard.latin.Constants.ImeOption.NO_MICROPHONE;
import static at.jku.fim.phonykeyboard.latin.Constants.ImeOption.NO_MICROPHONE_COMPAT;
...
import at.jku.fim.phonykeyboard.accessibility.AccessibilityUtils;
import at.jku.fim.phonykeyboard.accessibility.AccessibleKeyboardViewProxy;
import at.jku.fim.phonykeyboard.annotations.UsedForTesting;
import at.jku.fim.phonykeyboard.compat.AppWorkaroundsUtils;
import at.jku.fim.phonykeyboard.compat.InputMethodServiceCompatUtils;
import at.jku.fim.phonykeyboard.compat.SuggestionSpanUtils;
import at.jku.fim.phonykeyboard.event.EventInterpreter;
import at.jku.fim.phonykeyboard.keyboard.KeyDetector;
import at.jku.fim.phonykeyboard.keyboard.Keyboard;
import at.jku.fim.phonykeyboard.keyboard.KeyboardActionListener;
import at.jku.fim.phonykeyboard.keyboard.KeyboardId;
import at.jku.fim.phonykeyboard.keyboard.KeyboardSwitcher;
import at.jku.fim.phonykeyboard.keyboard.MainKeyboardView;
...
import at.jku.fim.phonykeyboard.latin.personalization.PersonalizationDictionarySessionRegister;
import at.jku.fim.phonykeyboard.latin.personalization.PersonalizationHelper;
import at.jku.fim.phonykeyboard.latin.personalization.PersonalizationPredictionDictionary;
import at.jku.fim.phonykeyboard.latin.personalization.UserHistoryDictionary;
import at.jku.fim.phonykeyboard.latin.settings.Settings;
import at.jku.fim.phonykeyboard.latin.settings.SettingsActivity;
import at.jku.fim.phonykeyboard.latin.settings.SettingsValues;
import at.jku.fim.phonykeyboard.latin.suggestions.SuggestionStripView;
import at.jku.fim.phonykeyboard.latin.utils.ApplicationUtils;
import at.jku.fim.phonykeyboard.latin.utils.AsyncResultHolder;
import at.jku.fim.phonykeyboard.latin.utils.AutoCorrectionUtils;
import at.jku.fim.phonykeyboard.latin.utils.CapsModeUtils;
import at.jku.fim.phonykeyboard.latin.utils.CollectionUtils;
import at.jku.fim.phonykeyboard.latin.utils.CompletionInfoUtils;
import at.jku.fim.phonykeyboard.latin.utils.InputTypeUtils;
import at.jku.fim.phonykeyboard.latin.utils.IntentUtils;
import at.jku.fim.phonykeyboard.latin.utils.JniUtils;
import at.jku.fim.phonykeyboard.latin.utils.LatinImeLoggerUtils;
import at.jku.fim.phonykeyboard.latin.utils.RecapitalizeStatus;
import at.jku.fim.phonykeyboard.latin.utils.StaticInnerHandlerWrapper;
import at.jku.fim.phonykeyboard.latin.utils.StringUtils;
import at.jku.fim.phonykeyboard.latin.utils.TargetPackageInfoGetterTask;
import at.jku.fim.phonykeyboard.latin.utils.TextRange;
import at.jku.fim.phonykeyboard.latin.utils.UserHistoryForgettingCurveUtils;
import at.jku.fim.phonykeyboard.research.ResearchLogger;
 ...
 */
public class PhonyKeyboard extends InputMethodService implements KeyboardActionListener,
        SuggestionStripView.Listener, TargetPackageInfoGetterTask.OnTargetPackageInfoKnownListener,
        Suggest.SuggestInitializationListener {
    private static final String TAG = PhonyKeyboard.class.getSimpleName();
    ...
    public static final class UIHandler extends StaticInnerHandlerWrapper<PhonyKeyboard> {
        ...
        public UIHandler(final PhonyKeyboard outerInstance) {
            super(outerInstance);
        }
        ...
        public void handleMessage(final Message msg) {
            final PhonyKeyboard phonyKeyboard = getOuterInstance();
            final KeyboardSwitcher switcher = phonyKeyboard.mKeyboardSwitcher;
            switch (msg.what) {
            case MSG_UPDATE_SUGGESTION_STRIP:
                phonyKeyboard.updateSuggestionStrip();
                break;
            ...
            case MSG_SHOW_GESTURE_PREVIEW_AND_SUGGESTION_STRIP:
                if (msg.arg1 == ARG1_NOT_GESTURE_INPUT) {
                    if (msg.arg2 == ARG2_WITH_TYPED_WORD) {
                        ...
                        phonyKeyboard.showSuggestionStripWithTypedWord(p.first, p.second);
                    } else {
                        phonyKeyboard.showSuggestionStrip((SuggestedWords) msg.obj);
                    }
                } else {
                    phonyKeyboard.showGesturePreviewAndSuggestionStrip((SuggestedWords) msg.obj,
                            msg.arg1 == ARG1_DISMISS_GESTURE_FLOATING_PREVIEW_TEXT);
                }
                break;
            case MSG_RESUME_SUGGESTIONS:
                phonyKeyboard.restartSuggestionsOnWordTouchedByCursor();
                break;
            case MSG_REOPEN_DICTIONARIES:
                phonyKeyboard.initSuggest();
            ...
            case MSG_ON_END_BATCH_INPUT:
                phonyKeyboard.onEndBatchInputAsyncInternal((SuggestedWords) msg.obj);
                break;
            case MSG_RESET_CACHES:
                phonyKeyboard.retryResetCaches(msg.arg1 == 1 /* tryResumeSuggestions */,
        ...
        public void startOrientationChanging() {
            ...
            final PhonyKeyboard phonyKeyboard = getOuterInstance();
            if (phonyKeyboard.isInputViewShown()) {
                phonyKeyboard.mKeyboardSwitcher.saveKeyboardState();
            }
        }
        ...
        private void executePendingImsCallback(final PhonyKeyboard phonyKeyboard, final EditorInfo editorInfo,
                boolean restarting) {
            if (mHasPendingFinishInputView)
                phonyKeyboard.onFinishInputViewInternal(mHasPendingFinishInput);
            if (mHasPendingFinishInput)
                phonyKeyboard.onFinishInputInternal();
            if (mHasPendingStartInput)
                phonyKeyboard.onStartInputInternal(editorInfo, restarting);
            resetPendingImsCallback();
        }
        ...
        public void onStartInput(final EditorInfo editorInfo, final boolean restarting) {
            if (hasMessages(MSG_PENDING_IMS_CALLBACK)) {
                ...
                final PhonyKeyboard phonyKeyboard = getOuterInstance();
                executePendingImsCallback(phonyKeyboard, editorInfo, restarting);
                phonyKeyboard.onStartInputInternal(editorInfo, restarting);
            }
        }
        ...
        public void onStartInputView(final EditorInfo editorInfo, final boolean restarting) {
            if (hasMessages(MSG_PENDING_IMS_CALLBACK)
                ...
                final PhonyKeyboard phonyKeyboard = getOuterInstance();
                executePendingImsCallback(phonyKeyboard, editorInfo, restarting);
                phonyKeyboard.onStartInputViewInternal(editorInfo, restarting);
        ...
        public void onFinishInputView(final boolean finishingInput) {
            if (hasMessages(MSG_PENDING_IMS_CALLBACK)) {
                ...
                final PhonyKeyboard phonyKeyboard = getOuterInstance();
                phonyKeyboard.onFinishInputViewInternal(finishingInput);
        ...
        public void onFinishInput() {
            if (hasMessages(MSG_PENDING_IMS_CALLBACK)) {
                ...
                final PhonyKeyboard phonyKeyboard = getOuterInstance();
                executePendingImsCallback(phonyKeyboard, null, false);
                phonyKeyboard.onFinishInputInternal();
            }
        }
    }
    ...
    static final class InputUpdater implements Handler.Callback {
        ...
        private final PhonyKeyboard mPhonyKeyboard;
        private final Object mLock = new Object();
        private boolean mInBatchInput; // synchronized using {@link #mLock}.

        InputUpdater(final PhonyKeyboard phonyKeyboard) {
            final HandlerThread handlerThread = new HandlerThread(
                    InputUpdater.class.getSimpleName());
            handlerThread.start();
            mHandler = new Handler(handlerThread.getLooper(), this);
            mPhonyKeyboard = phonyKeyboard;
        }
        ...
        public boolean handleMessage(final Message msg) {
            ...
            switch (msg.what) {
                ...
                case MSG_GET_SUGGESTED_WORDS:
                    mPhonyKeyboard.getSuggestedWords(msg.arg1 /* sessionId */,
        ...
        public void onStartBatchInput() {
            synchronized (mLock) {
                ...
                mInBatchInput = true;
                mPhonyKeyboard.mHandler.showGesturePreviewAndSuggestionStrip(
        ...
        public void onEndBatchInput(final InputPointers batchPointers) {
            synchronized(mLock) {
                getSuggestedWordsGestureLocked(batchPointers, SuggestedWords.NOT_A_SEQUENCE_NUMBER,
                    ...
                    public void onGetSuggestedWords(final SuggestedWords suggestedWords) {
                        mInBatchInput = false;
                        mPhonyKeyboard.mHandler.showGesturePreviewAndSuggestionStrip(suggestedWords,
                                true /* dismissGestureFloatingPreviewText */);
                        mPhonyKeyboard.mHandler.onEndBatchInput(suggestedWords);
                    }
                });
            }
        }
        ...
        private void getSuggestedWordsGestureLocked(final InputPointers batchPointers,
            ...
            mPhonyKeyboard.mWordComposer.setBatchInputPointers(batchPointers);
            mPhonyKeyboard.getSuggestedWordsOrOlderSuggestionsAsync(Suggest.SESSION_GESTURE,
                ...
                public void onGetSuggestedWords(SuggestedWords suggestedWords) {
                    ...
                    if (suggestionCount <= 1) {
                        ...
                        callback.onGetSuggestedWords(
                                mPhonyKeyboard.getOlderSuggestions(mostProbableSuggestion));
                    }
    ...
    private void launchSubActivity(final Class<? extends Activity> activityClass) {
        ...
        intent.setClass(PhonyKeyboard.this, activityClass);

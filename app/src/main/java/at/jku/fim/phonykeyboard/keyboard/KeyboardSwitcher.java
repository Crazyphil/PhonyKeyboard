...
import at.jku.fim.phonykeyboard.keyboard.KeyboardLayoutSet.KeyboardLayoutSetException;
import at.jku.fim.phonykeyboard.keyboard.internal.KeyboardState;
import at.jku.fim.phonykeyboard.latin.InputView;
...
public final class KeyboardSwitcher implements KeyboardState.SwitchActions {
    ...
    private PhonyKeyboard mPhonyKeyboard;
    ...
    public static void init(final PhonyKeyboard phonyKeyboard) {
        final SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(phonyKeyboard);
        sInstance.initInternal(phonyKeyboard, prefs);
    }

    private void initInternal(final PhonyKeyboard phonyKeyboard, final SharedPreferences prefs) {
        mPhonyKeyboard = phonyKeyboard;
        mResources = phonyKeyboard.getResources();
        mPrefs = prefs;
        mSubtypeSwitcher = SubtypeSwitcher.getInstance();
        mState = new KeyboardState(this);
        mIsHardwareAcceleratedDrawingEnabled =
                InputMethodServiceCompatUtils.enableHardwareAcceleration(mPhonyKeyboard);
    }

    public void updateKeyboardTheme() {
        final boolean themeUpdated = updateKeyboardThemeAndContextThemeWrapper(
                mPhonyKeyboard, getKeyboardTheme(mPhonyKeyboard, mPrefs));
        if (themeUpdated && mKeyboardView != null) {
            mPhonyKeyboard.setInputView(onCreateInputView(mIsHardwareAcceleratedDrawingEnabled));
        }
    }
    ...
    public void updateShiftState() {
        mState.onUpdateShiftState(mPhonyKeyboard.getCurrentAutoCapsState(),
                mPhonyKeyboard.getCurrentRecapitalizeState());
    }
    ...
    public void onPressKey(final int code, final boolean isSinglePointer) {
        mState.onPressKey(code, isSinglePointer, mPhonyKeyboard.getCurrentAutoCapsState());
    }
    ...
    public void onCodeInput(final int code) {
        mState.onCodeInput(code, mPhonyKeyboard.getCurrentAutoCapsState());
    }
    ...
    public View onCreateInputView(final boolean isHardwareAcceleratedDrawingEnabled) {
        ...
        updateKeyboardThemeAndContextThemeWrapper(mPhonyKeyboard, mKeyboardTheme);
